...
Create a well-structured commit with a concise title and optional bullet-point description for staged changes. Always includes AI attribution with the model name.
